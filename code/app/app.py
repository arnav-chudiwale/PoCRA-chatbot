...
def favicon():
    return send_from_directory(os.path.join(os.path.dirname(__file__), 'frontend'), 'favicon.ico', mimetype='image/vnd.microsoft.icon')


# Serve other static files, including those in the "src" directory
@app.route("/<path:filename>")
def serve_static(filename):
    return send_from_directory(os.path.join(os.path.dirname(__file__), 'frontend'), filename, mimetype='application/javascript')
